export default function TelevisionCoreSmall(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg width='72' height='72' viewBox='0 0 72 72' fill='none' {...props} xmlns='http://www.w3.org/2000/svg'>
