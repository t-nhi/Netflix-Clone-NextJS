...
import ActorsList from '@/app/[locale]/admin/actors/_components/actors-list'
            ...
            <main className='flex-1 p-6'>
                <div className='flex flex-row justify-end items-center mb-6 gap-4'>
                    <div className='flex flex-row gap-3 w-auto'>
                        <InputSearch placeholder={t('searchActors')} className='w-auto' />
                        <Tooltip>
                ...
                <ActorsList onEdit={handleEdit} onDelete={handleDelete} />
