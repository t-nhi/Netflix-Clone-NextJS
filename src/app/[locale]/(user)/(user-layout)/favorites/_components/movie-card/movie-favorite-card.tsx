...
export default function FavoriteCard({
    ...
    return (
        <article
            ...
            className={cn(
                'group relative w-full aspect-video rounded-[6px] overflow-hidden transition-all duration-300',
                'cursor-pointer',
        ...
        >
            ...
            <div className='absolute inset-0 bg-linear-to-b from-black/70 via-black/20 to-transparent flex items-start'>
            ...
            {mounted && movie.duration_minutes > 0 && progress > 0 && (
                <div className='absolute bottom-0 left-0 right-0 h-0.5 bg-gray-600/60'>
                    <div
